...
namespace Boxfusion.SheshaFunctionalTests.Common
{
    ...
    /// </summary>
    [DependsOn(
        typeof(SheshaFunctionalTestsCommonDomainModule),
    ...
    public class SheshaFunctionalTestsCommonApplicationModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            //Configuration.Settings.Providers.Add<SheshaFunctionalTestsDomainSettingProvider>();
            //Configuration.Authorization.Providers.Add<SheshaFunctionalTestsAuthorizationProvider>();        // Initiatlisation handled within Web project
            ...
            Configuration.Modules.ShaApplication().CreateAppServicesForEntities(typeof(SheshaFunctionalTestsCommonDomainModule).Assembly, "Common");
            Configuration.Modules.AbpAspNetCore().CreateControllersForAppServices(
                typeof(SheshaFunctionalTestsCommonDomainModule).Assembly,
                moduleName: "Common",
