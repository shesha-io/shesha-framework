...
const defaultTranspilePackages = ['antd'];
const nextConfig = (phase) => {
  ...
  const config = {
    ...
    transpilePackages: process.env.TRANSPILE_ALL_ANTD === 'true' ? legacyTranspilePackages : defaultTranspilePackages,
