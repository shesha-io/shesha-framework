...
export { type IShaDataTableProps } from '../components/indexTable/interfaces';
...
export { type ITableColumn, type ICustomFilter, type IDataTableInstance } from '../providers/dataTable/interfaces';
