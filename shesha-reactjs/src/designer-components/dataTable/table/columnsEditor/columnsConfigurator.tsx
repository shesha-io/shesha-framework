...
export const ColumnsConfigurator: FC<IColumnsConfiguratorProps> = ({ value, onChange, readOnly, componentName }) => {
  ...
  return (
    <ListEditorWithPropertiesPanel<ColumnsItemProps>
      ...
      itemProperties={(itemProps) => (<ColumnProperties item={itemProps.item} onChange={itemProps.onChange} readOnly={itemProps.readOnly} componentName={componentName} />)}
