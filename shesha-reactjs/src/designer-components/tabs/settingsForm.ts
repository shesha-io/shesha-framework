                                        ...
                                        .addCollapsiblePanel({
                                            ...
                                            content: {
                                                ...
                                                components: [...new DesignerToolbarSettings()
                                                    ...
                                                    .addCollapsiblePanel({
                                                        id: 'dimensionsStyleCollapsiblePanel',
                                                        propertyName: 'card.pnlDimensions',
                                                        label: 'Dimensions',
                                                        parentId: 'styleRouter',
                                                        labelAlign: 'right',
                                                        ghost: true,
                                                    ...
                                                    .addCollapsiblePanel({
                                                        id: 'borderStyleCollapsiblePanel',
                                                        propertyName: 'card.pnlBorderStyle',
                                                        label: 'Border',
                                                        labelAlign: 'right',
                                                        ghost: true,
                                                        parentId: 'styleRouter',
                                                        ...
                                                        content: {
                                                            ...
                                                            components: [...new DesignerToolbarSettings()
                                                                .addSettingsInputRow({
                                                                    id: `borderStyleRow`,
                                                                    parentId: 'borderStylePnl',
                                                                    hidden: { _code: 'return  !getSettingValue(data[`${contexts.canvasContext?.designerDevice || "desktop"}`]?.card?.border?.hideBorder);', _mode: 'code', _value: false } as any,
                                                                    readOnly: { _code: 'return getSettingValue(data?.readOnly);', _mode: 'code', _value: false } as any,
                                                                    inputs: [
                                                                        {
                                                                            type: 'button',
                                                                            ...
                                                                            label: "Border",
                                                                            hideLabel: true,
                                                                            propertyName: "card.border.hideBorder",
                                                                            icon: "EyeOutlined",
                                                                            iconAlt: "EyeInvisibleOutlined"
                                                                        },
                                                                    ]
