    ...
    return (
        <>
            ...
            },
            {
                ...
                <SettingInput key={name} dropdownOptions={options as IDropdownOption[]} label={label} propertyName={`inputStyles.background.${name}`} readOnly={readOnly} inputType='customDropdown' />
            ))}
        </>
    );
};
