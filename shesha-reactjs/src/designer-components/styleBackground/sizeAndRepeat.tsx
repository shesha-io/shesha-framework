    ...
    return (
        <>
            ...
            },
            {
                ...
                <SettingInput key={name} dropdownOptions={options as IDropdownOption[]} label={label} propertyName={`styles.background.${name}`} readOnly={readOnly} inputType='customDropdown' />
            ))}
        </>
    );
};
