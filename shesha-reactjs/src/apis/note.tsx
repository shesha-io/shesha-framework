...
export type NoteQueryProps = Omit<
  GetProps<NoteGraphQLDataResultAjaxResponse, AjaxResponseBase, NoteQueryQueryParams, void>,
  'path'
>;
...
export type UseNoteQueryProps = Omit<
  UseGetProps<NoteGraphQLDataResultAjaxResponse, AjaxResponseBase, NoteQueryQueryParams, void>,
  'path'
>;
 ...
 * NOTE: don't use on prod, will be merged with the `Get`endpoint soon
 */
export const useNoteQuery = (props: UseNoteQueryProps) =>
  useGet<NoteGraphQLDataResultAjaxResponse, AjaxResponseBase, NoteQueryQueryParams, void>(
 ...
 * NOTE: don't use on prod, will be merged with the `Get`endpoint soon
 */
export const noteQuery = (queryParams: NoteQueryQueryParams, props: noteQueryProps) =>
  RestfulShesha.get<NoteGraphQLDataResultAjaxResponse, AjaxResponseBase, NoteQueryQueryParams, void>(
    `/api/services/app/Note/Query`,
    queryParams,
    props
  );
...
export type NoteQueryAllProps = Omit<
  GetProps<NotePagedResultDtoGraphQLDataResultAjaxResponse, AjaxResponseBase, NoteQueryAllQueryParams, void>,
  'path'
>;
...
export type UseNoteQueryAllProps = Omit<
  UseGetProps<NotePagedResultDtoGraphQLDataResultAjaxResponse, AjaxResponseBase, NoteQueryAllQueryParams, void>,
  'path'
>;
 ...
 * NOTE: don't use on prod, will be merged with the GetAll endpoint soon
 */
export const useNoteQueryAll = (props: UseNoteQueryAllProps) =>
  useGet<NotePagedResultDtoGraphQLDataResultAjaxResponse, AjaxResponseBase, NoteQueryAllQueryParams, void>(
 ...
 * NOTE: don't use on prod, will be merged with the GetAll endpoint soon
 */
export const noteQueryAll = (queryParams: NoteQueryAllQueryParams, props: noteQueryAllProps) =>
  RestfulShesha.get<NotePagedResultDtoGraphQLDataResultAjaxResponse, AjaxResponseBase, NoteQueryAllQueryParams, void>(
    `/api/services/app/Note/QueryAll`,
    queryParams,
    props
  );
