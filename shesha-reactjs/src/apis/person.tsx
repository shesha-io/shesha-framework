...
export type PersonGetProps = Omit<
  GetProps<DynamicDtoPersonGuidAjaxResponse, AjaxResponseBase, PersonGetQueryParams, void>,
  'path'
>;
...
export type UsePersonGetProps = Omit<
  UseGetProps<DynamicDtoPersonGuidAjaxResponse, AjaxResponseBase, PersonGetQueryParams, void>,
  'path'
>;

export const usePersonGet = (props: UsePersonGetProps) =>
  useGet<DynamicDtoPersonGuidAjaxResponse, AjaxResponseBase, PersonGetQueryParams, void>(
    `/api/services/Shesha/Person/Get`,
    props
  );
...
export const personGet = (queryParams: PersonGetQueryParams, props: personGetProps) =>
  RestfulShesha.get<DynamicDtoPersonGuidAjaxResponse, AjaxResponseBase, PersonGetQueryParams, void>(
    `/api/services/Shesha/Person/Get`,
    queryParams,
    props
  );
...
export type PersonUpdateGqlProps = Omit<
  MutateProps<
    ...
    AjaxResponseBase,
    PersonUpdateGqlQueryParams,
    DynamicDtoPersonGuid,
    void
  >,
  'path' | 'verb'
>;
...
export type UsePersonUpdateGqlProps = Omit<
  UseMutateProps<
    PersonGraphQLDataResultAjaxResponse,
    AjaxResponseBase,
    PersonUpdateGqlQueryParams,
 ...
 * NOTE: don't use on prod, will be merged with the `Update`endpoint soon
 */
export const usePersonUpdateGql = (props: UsePersonUpdateGqlProps) =>
  useMutate<
    PersonGraphQLDataResultAjaxResponse,
    AjaxResponseBase,
    PersonUpdateGqlQueryParams,
    DynamicDtoPersonGuid,
    void
  >('PUT', `/api/services/Shesha/Person/UpdateGql`, props);
 ...
 * NOTE: don't use on prod, will be merged with the `Update`endpoint soon
 */
export const personUpdateGql = (data: DynamicDtoPersonGuid, props: personUpdateGqlProps) =>
  RestfulShesha.mutate<
    ...
    DynamicDtoPersonGuid,
    void
  >('PUT', `/api/services/Shesha/Person/UpdateGql`, data, props);
...
export type PersonUpdateProps = Omit<
  MutateProps<DynamicDtoPersonGuidAjaxResponse, AjaxResponseBase, PersonUpdateQueryParams, DynamicDtoPersonGuid, void>,
  'path' | 'verb'
>;
...
export type UsePersonUpdateProps = Omit<
  UseMutateProps<
    DynamicDtoPersonGuidAjaxResponse,
    AjaxResponseBase,
...
export const usePersonUpdate = (props: UsePersonUpdateProps) =>
  useMutate<DynamicDtoPersonGuidAjaxResponse, AjaxResponseBase, PersonUpdateQueryParams, DynamicDtoPersonGuid, void>(
    'PUT',
    `/api/services/Shesha/Person/Update`,
    props
  );
...
export type personUpdateProps = Omit<
  ...
  'data'
>;
export const personUpdate = (data: DynamicDtoPersonGuid, props: personUpdateProps) =>
  RestfulShesha.mutate<
    DynamicDtoPersonGuidAjaxResponse,
    AjaxResponseBase,
    PersonUpdateQueryParams,
    DynamicDtoPersonGuid,
    void
  >('PUT', `/api/services/Shesha/Person/Update`, data, props);
...
export type UsePersonCreateGqlProps = Omit<
  UseMutateProps<
    PersonGraphQLDataResultAjaxResponse,
    AjaxResponseBase,
    PersonCreateGqlQueryParams,
 ...
 * NOTE: don't use on prod, will be merged with the `Update`endpoint soon
 */
export const usePersonCreateGql = (props: UsePersonCreateGqlProps) =>
  useMutate<
    PersonGraphQLDataResultAjaxResponse,
    AjaxResponseBase,
    PersonCreateGqlQueryParams,
    DynamicDtoPersonGuid,
    void
  >('POST', `/api/services/Shesha/Person/CreateGql`, props);
 ...
 * NOTE: don't use on prod, will be merged with the `Update`endpoint soon
 */
export const personCreateGql = (data: DynamicDtoPersonGuid, props: personCreateGqlProps) =>
  RestfulShesha.mutate<
    PersonGraphQLDataResultAjaxResponse,
    AjaxResponseBase,
    PersonCreateGqlQueryParams,
    DynamicDtoPersonGuid,
    void
  >('POST', `/api/services/Shesha/Person/CreateGql`, data, props);
...
export type PersonCreateProps = Omit<
  MutateProps<DynamicDtoPersonGuidAjaxResponse, AjaxResponseBase, PersonCreateQueryParams, DynamicDtoPersonGuid, void>,
  'path' | 'verb'
>;
...
export const usePersonCreate = (props: UsePersonCreateProps) =>
  useMutate<DynamicDtoPersonGuidAjaxResponse, AjaxResponseBase, PersonCreateQueryParams, DynamicDtoPersonGuid, void>(
    'POST',
    `/api/services/Shesha/Person/Create`,
    props
  );
...
export type personCreateProps = Omit<
  ...
  'data'
>;
export const personCreate = (data: DynamicDtoPersonGuid, props: personCreateProps) =>
  RestfulShesha.mutate<
    DynamicDtoPersonGuidAjaxResponse,
    AjaxResponseBase,
    PersonCreateQueryParams,
    DynamicDtoPersonGuid,
    void
  >('POST', `/api/services/Shesha/Person/Create`, data, props);
...
export type PersonGetAllProps = Omit<
  GetProps<DynamicDtoPersonGuidPagedResultDtoAjaxResponse, AjaxResponseBase, PersonGetAllQueryParams, void>,
  'path'
>;
...
export type UsePersonGetAllProps = Omit<
  UseGetProps<DynamicDtoPersonGuidPagedResultDtoAjaxResponse, AjaxResponseBase, PersonGetAllQueryParams, void>,
  'path'
>;

export const usePersonGetAll = (props: UsePersonGetAllProps) =>
  useGet<DynamicDtoPersonGuidPagedResultDtoAjaxResponse, AjaxResponseBase, PersonGetAllQueryParams, void>(
    `/api/services/Shesha/Person/GetAll`,
    props
  );

export type personGetAllProps = Omit<
  RestfulShesha.GetProps<
    DynamicDtoPersonGuidPagedResultDtoAjaxResponse,
    AjaxResponseBase,
...
export const personGetAll = (queryParams: PersonGetAllQueryParams, props: personGetAllProps) =>
  RestfulShesha.get<DynamicDtoPersonGuidPagedResultDtoAjaxResponse, AjaxResponseBase, PersonGetAllQueryParams, void>(
    `/api/services/Shesha/Person/GetAll`,
    queryParams,
    props
  );
...
export type PersonQueryProps = Omit<
  GetProps<PersonGraphQLDataResultAjaxResponse, AjaxResponseBase, PersonQueryQueryParams, void>,
  'path'
>;
...
export type UsePersonQueryProps = Omit<
  UseGetProps<PersonGraphQLDataResultAjaxResponse, AjaxResponseBase, PersonQueryQueryParams, void>,
  'path'
>;
 ...
 * NOTE: don't use on prod, will be merged with the `Get`endpoint soon
 */
export const usePersonQuery = (props: UsePersonQueryProps) =>
  useGet<PersonGraphQLDataResultAjaxResponse, AjaxResponseBase, PersonQueryQueryParams, void>(
    `/api/services/Shesha/Person/Query`,
    props
  );
 ...
 * NOTE: don't use on prod, will be merged with the `Get`endpoint soon
 */
export const personQuery = (queryParams: PersonQueryQueryParams, props: personQueryProps) =>
  RestfulShesha.get<PersonGraphQLDataResultAjaxResponse, AjaxResponseBase, PersonQueryQueryParams, void>(
    `/api/services/Shesha/Person/Query`,
    queryParams,
    props
  );
...
export type PersonQueryAllProps = Omit<
  GetProps<PersonPagedResultDtoGraphQLDataResultAjaxResponse, AjaxResponseBase, PersonQueryAllQueryParams, void>,
  'path'
>;
...
export type UsePersonQueryAllProps = Omit<
  UseGetProps<PersonPagedResultDtoGraphQLDataResultAjaxResponse, AjaxResponseBase, PersonQueryAllQueryParams, void>,
  'path'
>;
 ...
 * NOTE: don't use on prod, will be merged with the GetAll endpoint soon
 */
export const usePersonQueryAll = (props: UsePersonQueryAllProps) =>
  useGet<PersonPagedResultDtoGraphQLDataResultAjaxResponse, AjaxResponseBase, PersonQueryAllQueryParams, void>(
    `/api/services/Shesha/Person/QueryAll`,
    props
  );
 ...
 * NOTE: don't use on prod, will be merged with the GetAll endpoint soon
 */
export const personQueryAll = (queryParams: PersonQueryAllQueryParams, props: personQueryAllProps) =>
  RestfulShesha.get<
    PersonPagedResultDtoGraphQLDataResultAjaxResponse,
    AjaxResponseBase,
    PersonQueryAllQueryParams,
    void
  >(`/api/services/Shesha/Person/QueryAll`, queryParams, props);
...
export const usePersonDelete = (props: UsePersonDeleteProps) =>
  useMutate<void, unknown, PersonDeleteQueryParams, void, void>('DELETE', `/api/services/Shesha/Person/Delete`, {
    ...props,
  });
...
export const personDelete = (props: personDeleteProps) =>
  RestfulShesha.mutate<void, unknown, PersonDeleteQueryParams, void, void>(
    'DELETE',
    `/api/services/Shesha/Person/Delete`,
    undefined,
    props
  );
