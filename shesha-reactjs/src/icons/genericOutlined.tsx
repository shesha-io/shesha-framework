...
const GenericOutlinedSvg = (): JSX.Element => (
...
export const GenericOutlined: FC<Partial<CustomIconComponentProps>> = (props) => {
  return <Icon component={GenericOutlinedSvg} {...props} />;
};

export default GenericOutlined;
