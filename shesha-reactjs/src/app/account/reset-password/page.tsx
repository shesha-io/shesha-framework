...
import PasswordConfirmPasswordInputs, { IPasswordConfirmPassword } from '@/app-components/global/passwordConfirmPasswordInputs/index';
import { ResetPasswordContainer } from '@/app-components/pages/account/reset-password/styles';
import { SmileOutlined } from '@ant-design/icons';
import { URL_LOGIN_PAGE } from '@/shesha-constants/standard-routes';
import { useAuth } from '@/providers';
import { useRouter } from 'next/navigation';
import { useUserResetPasswordUsingToken } from '@/apis/user';
