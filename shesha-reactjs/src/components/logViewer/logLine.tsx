...
const LogLineComponentRenderer: FC<LogLineProps> = ({
  ...
  const getLineStyles = (): string => {
    ...
    switch (level) {
      case LogLevel.ERROR:
        baseStyles.push(styles.logLineError);
        break;
      case LogLevel.WARNING: {
        baseStyles.push(styles.logLineWarning);
        break;
      }
      case LogLevel.SUCCESS: {
        baseStyles.push(styles.logLineSuccess);
        break;
      }
      case LogLevel.SECTION: {
        baseStyles.push(styles.logLineSection);
        break;
      }
    }
...
export const LogLineComponent = memo(LogLineComponentRenderer);
