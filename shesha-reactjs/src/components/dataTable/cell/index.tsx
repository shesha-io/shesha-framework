...
import { ITableActionColumn, ITableCrudOperationsColumn, ITableDataColumn } from "providers/dataTable/interfaces";
...
export const getCellRenderer = <D extends object = {}, V = any>(column: ITableColumn, metadata: IModelMetadata): Renderer<CellProps<D, V>> | undefined => {
