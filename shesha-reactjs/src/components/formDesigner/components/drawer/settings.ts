      ...
      content: {
        ...
        components: [...new DesignerToolbarSettings()  
          ...
          .addTextField({
            ...
            hidden: {_code: 'return  getSettingValue(data?.placement) !== "right" && getSettingValue(data?.placement) !== "left";', _mode: 'code', _value: false} as any,
          })
          .addTextField({
            id: nanoid(),
            propertyName: 'height',
            ...
            hidden: {_code: 'return  getSettingValue(data?.placement) !== "bottom" && getSettingValue(data?.placement) !== "top";', _mode: 'code', _value: false} as any,
            placeholder: '70% or 800px',
          }).toJson()
        ]
      }
