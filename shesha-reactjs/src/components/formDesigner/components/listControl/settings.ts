...
export const listSettingsForm = new DesignerToolbarSettings()
  ...
  .addCheckbox({
    propertyName: 'allowAddAndRemove',
  ...
  .addSectionSeparator({
    ...
    propertyName: 'separatorRenderStrategy',
    parentId: 'root',
    label: 'Render',
  })
  .addDropdown({
  ...
  .addSectionSeparator({
    ...
    propertyName: 'separatorPagination',
    parentId: 'root',
    label: 'Pagination',
  })
  .addCheckbox({
    id: 'c94b5f19-094d-479d-991b-f24c7768bdf5',
    propertyName: 'showPagination',
    parentId: 'root',
  ...
  .addNumberField({
    ...
    propertyName: 'paginationDefaultPageSize',
