...
if (!window['switchDevMode']) {
  window['switchDevMode'] = function() {
    const dev = localStorage.getItem("sheshaDevMode");
    localStorage.setItem("sheshaDevMode", dev === "true" ? "false" : "true");
    console.log("sheshaDevMode: " + localStorage.getItem("sheshaDevMode"));
  };
};
...
export const ToolboxComponents: IToolboxComponentGroup[] = [
  ...
  {
    visible: localStorage.getItem("sheshaDevMode") === "true",
    name: 'Dev',
    components: [
