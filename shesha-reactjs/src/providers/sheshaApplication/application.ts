...
export class SheshaApplicationInstance implements ISheshaApplicationInstance {
    ...
    setRequestHeaders = (headers: IRequestHeaders) => {
        this.#httpHeaders = { ...this.#httpHeaders, ...headers, [FRONT_END_APP_HEADER_NAME]: this.#applicationKey };
        this.#rerender();
    };
...
export const SheshaApplicationInstanceContext = createNamedContext<ISheshaApplicationInstance>(undefined, "SheshaApplicationInstanceContext");