...
import { ButtonGroupItemProps, IButtonGroup, IButtonItem } from './models';
...
export { ButtonGroupConfiguratorProvider, useButtonGroupConfigurator, IButtonGroup, IButtonItem };
