...
export const FncSheshaAddressCreate = addStory(Template, {
  formId: { name: 'address-create', module: 'Shesha' },
});

export const FncSheshaFunctionalTestAddressCreate = addStory(Template, {
  formId: { name: 'address-create', module: 'Boxfusion.SheshaFunctionalTests.Common' },
});
