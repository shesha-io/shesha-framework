...
namespace Shesha.Tests.CamelCase
{
    ...
    public class CamelCase_Tests
    {
        ...
        [InlineData("..foo..bar..", "..fooBar")]
        [InlineData("foo_bar", "fooBar")]
        [InlineData("__foo__bar__", "__fooBar")]
        [InlineData("foo bar", "fooBar")]
        [InlineData("  foo  bar  ", "fooBar")]
        [InlineData("-", "")]
        [InlineData(" - ", "")]
        ...
        public void LeadingCamelCase_Test(string input, string expected)
        {
            var converted = CamelCaseHelper.Convert(input, new CamelCaseHelper.ConvertOptions() { KeepLeadingSeparators = true });
            Assert.Equal(expected, converted);
        }
