...
namespace Shesha.OmoNotifications.Emails.Gateways
{
    public class SmtpGateway : IEmailGateway
    {
        ...
        public Task<bool> SendAsync(string fromPerson, string toPerson, OmoNotificationMessage message, bool isBodyHtml, string cc = "", bool throwException = false, List<EmailAttachment> attachments = null)
        {
