...
namespace Shesha.Redis
{
    ...
    /// Note: copy of ABP implementaiton of ConditionalValue with nullability support
    /// </summary>
    /// <typeparam name="TValue">The type of the value returned by this <cref name="ConditionalValue{TValue}"/>.</typeparam>
    public struct ShaConditionalValue<TValue>
    {
        /// <summary>
        ...
        public ShaConditionalValue(bool hasValue, TValue? value)
        {
            HasValue = hasValue;
            Value = value;
        }
