    ...
    public class DynamicEntitiesMapProfile: ShaProfile
    {
        public DynamicEntitiesMapProfile()
        {
            ...
            CreateMap<EntityConfig, EntityConfigDto>()
                .ForMember(e => e.Suppress, c => c.MapFrom(e => e.Configuration.Suppress))
                .ForMember(e => e.Name, c => c.MapFrom(e => e.Configuration.Name))
                .ForMember(e => e.Label, c => c.MapFrom(e => e.Configuration.Label))
                .ForMember(e => e.Description, c => c.MapFrom(e => e.Configuration.Description))
                .ForMember(e => e.VersionNo, c => c.MapFrom(e => e.Configuration.VersionNo))
                .ForMember(e => e.VersionStatus, c => c.MapFrom(e => e.Configuration.VersionStatus))
                .ForMember(e => e.Module, c => c.MapFrom(e => e.Configuration.Module != null ? e.Configuration.Module.Name : ""))
                .ForMember(e => e.ModuleId, c => c.MapFrom(e => e.Configuration.Module != null ? e.Configuration.Module.Id : Guid.Empty))
                ;
