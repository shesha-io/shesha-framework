...
{
    [JoinedProperty("setting_config_revisions", Schema = "frwk")]
    [SnakeCaseNaming]
    [DiscriminatorValue(SettingConfiguration.ItemTypeName)]
    public class SettingConfigurationRevision : ConfigurationItemRevision
    {
        /// <summary>
        ...
        /// </summary>
        [Audited]
        public virtual RefListSettingAccessMode AccessMode { get; set; }
        ...
        /// </summary>
        [Audited]
        public virtual RefListUserSettingAccessMode ClientAccess { get; set; }
    }
}
