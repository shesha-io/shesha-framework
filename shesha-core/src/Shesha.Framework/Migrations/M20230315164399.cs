...
namespace Shesha.Migrations
{
    ...
    public class M20230315164399 : OneWayMigration
    {
        public override void Up()
        {
            ...
            Execute.Sql(@"create unique index uq_Frwk_ConfigurationItems_LiveVersion on Frwk_ConfigurationItems(Name, ModuleId, ItemType, TenantId) where IsDeleted=0 and VersionStatusLkp = 3");
...
on 
	Frwk_ConfigurationItems(Name, ModuleId, ItemType, TenantId, VersionNo)
where 
	IsDeleted = 0");
