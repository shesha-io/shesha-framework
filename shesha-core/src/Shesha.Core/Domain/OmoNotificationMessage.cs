...
{
    [Entity(TypeShortAlias = "Shesha.Core.OmoNotificationMessage")]
    public class OmoNotificationMessage : FullAuditedEntityWithExternalSync<Guid>, IMayHaveTenant
    {
        /// <summary>
        /// 
        /// </summary>
        public virtual OmoNotification PartOf { get; set; }
        /// <summary>
        /// 
        /// </summary>
